...
};System.register(['aurelia-dependency-injection', 'aurelia-templating', 'aurelia-logging', 'aurelia-logging'], function(exports_1) {
    var aurelia_dependency_injection_1, aurelia_templating_1, aurelia_logging_1, LogManager;
    var GlobalBehavior;
    return {
        setters:[
        ...
        execute: function() {
            ...
            exports_1("GlobalBehavior", GlobalBehavior);
