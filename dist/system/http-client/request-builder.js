System.register(['./http-request-message', './jsonp-request-message'], function(exports_1) {
    var http_request_message_1, jsonp_request_message_1;
    var RequestBuilder;
    return {
        setters:[
        ...
        execute: function() {
            ...
            */
            RequestBuilder = (function () {
                ...
                * @chainable
                */
                RequestBuilder.addHelper = function (name, fn) {
            ...
            exports_1("RequestBuilder", RequestBuilder);
