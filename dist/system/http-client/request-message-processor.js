System.register(['./http-response-message', 'aurelia-path'], function(exports_1) {
    var http_response_message_1, aurelia_path_1;
    var RequestMessageProcessor;
    ...
    return {
        setters:[
            function (_http_response_message_1) {
                http_response_message_1 = _http_response_message_1;
            },
        ...
        execute: function() {
            ...
            exports_1("RequestMessageProcessor", RequestMessageProcessor);
        }
    }
});
