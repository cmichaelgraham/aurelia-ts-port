    ...
    return {
        ...
        execute: function() {
            ...
            ChildObserver = (function () {
                ...
                ChildObserver.prototype.createBinding = function (target, behavior) {
                    return new ChildObserverBinder(this.selector, target, this.property, behavior, this.changeHandler);
                };
                return ChildObserver;
            })();
            exports_1("ChildObserver", ChildObserver);
            ChildObserverBinder = (function () {
                ...
                ChildObserverBinder.prototype.onChange = function (mutations) {
            ...
            exports_1("ChildObserverBinder", ChildObserverBinder);
        }
    }
});
