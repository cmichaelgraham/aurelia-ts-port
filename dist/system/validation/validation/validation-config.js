System.register(['../validation/validation-locale', '../validation/validate-custom-attribute-view-strategy'], function(exports_1) {
    var validation_locale_1, validate_custom_attribute_view_strategy_1;
    var ValidationConfigDefaults, ValidationConfig;
    return {
        setters:[
            ...
            function (_validate_custom_attribute_view_strategy_1) {
                validate_custom_attribute_view_strategy_1 = _validate_custom_attribute_view_strategy_1;
            }],
        execute: function() {
            ValidationConfigDefaults = (function () {
                function ValidationConfigDefaults() {
                }
                return ValidationConfigDefaults;
            })();
            exports_1("ValidationConfigDefaults", ValidationConfigDefaults);
            ...
            exports_1("ValidationConfig", ValidationConfig);
