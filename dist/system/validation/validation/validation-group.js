System.register(['../validation/validation-group-builder', '../validation/validation-result'], function(exports_1) {
    var validation_group_builder_1, validation_result_1;
    var ValidationGroup;
    return {
        setters:[
            function (_validation_group_builder_1) {
                validation_group_builder_1 = _validation_group_builder_1;
            },
            function (_validation_result_1) {
                validation_result_1 = _validation_result_1;
            }],
        execute: function() {
            /**
