System.register(['aurelia-metadata', 'aurelia-logging', './metadata'], function(exports_1) {
    var aurelia_metadata_1, aurelia_logging_1, metadata_1;
    var emptyParameters, Container;
    ...
    return {
        ...
        execute: function() {
            ...
            exports_1("emptyParameters", emptyParameters = Object.freeze([]));
            /**
            ...
            Container = (function () {
                ...
                */
                ...
                Container.prototype.createConstructionInfo = function (fn) {
                    ...
                    if (this.locateParameterInfoElsewhere !== undefined) {
                        info.keys = this.locateParameterInfoElsewhere(fn) || Reflect.getOwnMetadata(aurelia_metadata_1.Metadata.paramTypes, fn) || emptyParameters;
                    }
                    else {
                        info.keys = Reflect.getOwnMetadata(aurelia_metadata_1.Metadata.paramTypes, fn) || emptyParameters;
                    }
                    return info;
                };
                return Container;
