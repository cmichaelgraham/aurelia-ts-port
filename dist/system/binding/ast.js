var __extends = (this && this.__extends) || function (d, b) {
    ...
    d.prototype = new __();
};System.register(['./path-observer', './composite-observer', './access-keyed-observer'], function(exports_1) {
    var path_observer_1, composite_observer_1, access_keyed_observer_1;
    var Expression, Chain, ValueConverter, Assign, Conditional, AccessScope, AccessMember, AccessKeyed, CallScope, CallMember, CallFunction, Binary, PrefixNot, LiteralPrimitive, LiteralString, LiteralArray, LiteralObject, Unparser, evalListCache;
    ...
    return {
        setters:[
            ...
            function (_composite_observer_1) {
                composite_observer_1 = _composite_observer_1;
            },
            function (_access_keyed_observer_1) {
                access_keyed_observer_1 = _access_keyed_observer_1;
            }],
        execute: function() {
            Expression = (function () {
                function Expression() {
            ...
            ValueConverter = (function (_super) {
            ...
            exports_1("AccessScope", AccessScope);
            AccessMember = (function (_super) {
            ...
            exports_1("AccessMember", AccessMember);
            AccessKeyed = (function (_super) {
            ...
            exports_1("AccessKeyed", AccessKeyed);
            CallScope = (function (_super) {
            ...
            exports_1("CallScope", CallScope);
            CallMember = (function (_super) {
            ...
            exports_1("CallMember", CallMember);
            CallFunction = (function (_super) {
            ...
            exports_1("CallFunction", CallFunction);
            ...
            exports_1("LiteralObject", LiteralObject);
            Unparser = (function () {
