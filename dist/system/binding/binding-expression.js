System.register(['./binding-modes'], function(exports_1) {
    var binding_modes_1;
    var BindingExpression, Binding;
    return {
        setters:[
            function (_binding_modes_1) {
                binding_modes_1 = _binding_modes_1;
            }],
        execute: function() {
            ...
            exports_1("BindingExpression", BindingExpression);
            Binding = (function () {
