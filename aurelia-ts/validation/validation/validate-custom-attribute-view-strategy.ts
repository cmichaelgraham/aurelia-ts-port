...
export class TWBootstrapViewStrategy extends ValidateCustomAttributeViewStrategyBase {
  appendMessageToInput;
  appendMessageToLabel;
  helpBlockClass;
...
(<any>ValidateCustomAttributeViewStrategy).TWBootstrapAppendToInput = new TWBootstrapViewStrategy(true, false, 'aurelia-validation-message');
(<any>ValidateCustomAttributeViewStrategy).TWBootstrapAppendToMessage = new TWBootstrapViewStrategy(false, true, 'aurelia-validation-message');
