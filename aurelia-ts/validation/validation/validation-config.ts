...
ValidationConfigDefaults._defaults = {
  ...
  viewStrategy : (<any>ValidateCustomAttributeViewStrategy).TWBootstrapAppendToMessage
};
...
export class ValidationConfig {
  ...
  useLocale(localeIdentifier){
    ...
    var callbacks:any = Array.from(this.changedHandlers.values());
