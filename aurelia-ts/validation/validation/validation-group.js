define(["require", "exports", '../validation/validation-group-builder', '../validation/validation-result'], function (require, exports, _validation_group_builder, _validation_result) {
    /**
    ...
    var ValidationGroup = (function () {
        ...
        function ValidationGroup(subject, observerLocator) {
            this.result = new _validation_result.ValidationResult();
            this.subject = subject;
            this.validationProperties = [];
            this.builder = new _validation_group_builder.ValidationGroupBuilder(observerLocator, this);
        }
        /**
