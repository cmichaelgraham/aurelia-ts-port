define(["require", "exports", '../validation/validation-rules', '../validation/validation-rules-collection', '../validation/validation-property'], function (require, exports, AllRules, AllCollections, _validation_property) {
    var ValidationGroupBuilder = (function () {
        ...
        ValidationGroupBuilder.prototype.ensure = function (propertyName) {
            ...
            if (newValidationProperty === null) {
                ...
                newValidationProperty = new _validation_property.ValidationProperty(this.observerLocator, propertyName, this.validationGroup, propertyResult);
