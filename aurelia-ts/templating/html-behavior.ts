...
export class HtmlBehaviorResource extends ResourceType {
  ...
  public hasDynamicOptions;
  public properties;
  public attributes;
  public observerLocator;
  public taskQueue;
  public target;
  public handlesCreated;
  public handlesBind;
  public handlesUnbind;
  public handlesAttached;
  public handlesDetached;
  public apiName;
  public viewStrategy;
  public viewFactory;
  constructor(){
  ...
  create(container, instruction:any=defaultInstruction, element=null, bindings?){
    var executionContext = instruction.executionContext || container.get(this.target),
        behaviorInstance:any = new BehaviorInstance(this, executionContext, instruction),
        viewFactory, host;
